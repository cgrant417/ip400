#!/bin/bash
# Startup script for IP400 TUN bridge
# Point-to-point tunnel over IP400 mesh network

# Configuration - MODIFY THESE FOR YOUR SETUP
MY_CALLSIGN="VE3AC"           # My callsign
GATEWAY_CALLSIGN="VE3CA"      # Remote tunnel endpoint callsign
TUNNEL_IP="10.0.0.2/24"       # My tunnel IP address
...
echo "  ping ${TUNNEL_IP%/*}"  # Remove /24 to show just IP
echo ""
